...
public class SearchRouter {
	...
	protected RouterFunction<ServerResponse> formRouter(){
		return RouterFunctions.route(RequestPredicates.GET("/"), request -> ServerResponse.ok().render("search.html"));
	}
	
	protected RouterFunction<ServerResponse> searchRouter(SearchHandler searchHandler){
		
		return RouterFunctions
				.route(RequestPredicates.POST("/search")
